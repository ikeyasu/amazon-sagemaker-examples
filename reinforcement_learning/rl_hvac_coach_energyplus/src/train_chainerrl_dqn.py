# based on https://github.com/chainer/chainerrl/blob/v0.5.0/examples/gym/train_dqn_gym.py
...
def main():
    ...
    def make_env(test):
        ...
        if args.monitor:
            env = gym.wrappers.Monitor(env, args.output_data_dir)
    ...
    timestep_limit = env.unwrapped.MAXSTEPS + 1
    ...
    if args.demo:
        ...
        experiments.train_agent_with_evaluation(
            ...
            max_episode_len=timestep_limit, eval_max_episode_len=timestep_limit)
